-- Add introduction field to club join requests and match participants
-- for application self-introduction messages

-- club_join_requests already has a 'message' column, add dedicated 'introduction'
ALTER TABLE public.club_join_requests
  ADD COLUMN IF NOT EXISTS introduction TEXT;

-- match_participants: add introduction for guest applications
ALTER TABLE public.match_participants
  ADD COLUMN IF NOT EXISTS introduction TEXT;

-- Update the join_match_atomically RPC to accept introduction
