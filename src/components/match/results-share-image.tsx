    ...
    return (
      ...
      >
        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
          ...
          <span style={{ fontSize: 13, color: '#666666' }}>경기 결과</span>
        </div>
        ...
        {funStats.length > 0 && (
          <div style={{ marginBottom: 36 }}>
            ...
            <div style={{ display: 'flex', gap: 12 }}>
              {funStats.map((s, i) => (
                <div key={i} style={{ flex: 1, background: '#1A1A1A', border: '1px solid #2A2A2A', borderRadius: 12, padding: 16, textAlign: 'center' }}>
                ...
                <div key={order} style={{ marginBottom: 20 }}>
                  ...
                  <div style={{ display: 'flex', gap: 10 }}>
                    {slotGames.map((game, i) => (
                      <div key={i} style={{ flex: 1, background: '#1A1A1A', border: '1px solid #2A2A2A', borderRadius: 12, padding: '12px 16px' }}>
        ...
        {/* Footer */}
        <div style={{ marginTop: 40, paddingTop: 20, borderTop: '1px solid #222222', display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <span style={{ fontSize: 13, color: '#555555' }}>테놀 - 테니스 치며 놀자</span>
          <span style={{ fontSize: 12, color: '#444444' }}>tenol.app</span>
        </div>
      </div>
    );
  }
